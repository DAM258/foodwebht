// 文件工具类
const fs = require("fs");
const formidable = require("formi dable");
 ...
 *      maxFileSize :200 * 1024 * 1024， 文件最大的大小 单位b
...
function upload(req, options) {
    ...
    var cacheFolder = options.fileDir?options.fileDir:'public/file';
    ...
    form.maxFileSize  = options.maxFileSize ? options.maxFileSize  : 200 * 1024 * 1024; //文件大小
    form.type = true;
